...
kr1 = KRIS.LINE()
#kr1.login(qr=True)
kr1.login(token="Eo7cxixUdXC82UQDHCZ4.Espwl7CcKKW9erpIgvmoTa.ktxYucrm+7hC9fSLIT1z3U7g8Vu4PNFGLSQytjw8Uw8=")
kr1.loginResult()

kr2 = KRIS.LINE()
#kr2.login(qr=True)
kr2.login(token="EoV2ReIIeCcjdZfAhZj5.ZdEVdlBW/9hX2wGip2xx1q.22oxWmCj0ULHfvXlzgg8mjfTLXQAUORTl1VLRSe5VEo=")
kr2.loginResult()

kr3 = KRIS.LINE()
#kr3.login(qr=True)
kr3.login(token="EovHnrccerGAfHxMy7La.m05PgfJ20OHCnyQJ8clMQG.cWUoWgrSbnMW6fPsLTMFSxeSj1/jyGT8nmyzl0Uyfrk=")
kr3.loginResult()

kr4 = KRIS.LINE()
#kr4.login(qr=True)
kr4.login(token="EoSe6fonf7BymZk5SpR3.eFqKRkdx3UCPENti1CVbCW.tsbnrmFll0lzBCOW3AlwF2ZXx4uCSK+jV2VV6jXyVdQ=")
kr4.loginResult()

kr5 = KRIS.LINE()
kr5.login(qr=True)
kr5.login(token="EozrH9hW5nt4pRD5616f.CiOESA9RpOVz1/qwAI8chW.XYPFA1ZTXFgM95rOgYAUEYyL5uq6P/cCUtmwXUIyt7w=")
kr5.loginResult()
...
["u7923d62fb702924c3d1113e219530eb4"]
mid2 = kr2.getProfile().mid
["ucc37af0cb6f0fbd1f1d968083f65d7d5"]
mid3 = kr3.getProfile().mid
["u334e691858f6d2885c358aa3f022e6aa"]
mid4 = kr4.getProfile().mid
["u11f424aca0d7dee7297a74c8d5cbc173"]
mid5 = kr5.getProfile().mid
["u708a1eb1af6b3e8bd9d7e4166a2f021f"]
#mid6 = kr6.getProfile().mid
#["u6343eae35309ae7ff3c2ea431a2a97ad"]


Bots=[mid,mid2,mid3,mid4,mid5]
owner=["u0710a42a75e0a476ad687639db8c069c"]
admin=["u0710a42a75e0a476ad687639db8c069c",mid,mid2,mid3,mid4,mid5]
